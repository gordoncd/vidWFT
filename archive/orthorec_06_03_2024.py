...
ARCHIVE OF module orthorec.py FROM 07/10/2024
Approach changed to not include rectification step so much of the module became unimportant
some helper functions are still used so another version of this file persists in the core codebase
