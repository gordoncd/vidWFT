...
'''
generated with github copilot with prompt : generate an object tracking script'''


num_stakes = 2
# Load the video
cap = cv2.VideoCapture('videos/noodle_float_move_rect.mp4')
...
#make a graph from the position: 
